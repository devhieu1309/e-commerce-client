export const vetaikhoan = [
    {
        question: "1. Làm thế nào để tôi trở thành thành viên của Dola?",
        answer: "Quý khách vui lòng nhấn vào nút “Đăng ký” ở thanh menu trên cùng của màn hình (Đối với Desktop) hoặc tại góc trái màn hình, chọn biểu tượng Menu rồi chọn “Đăng ký” (Đối với Mobile)."
    },
    {
        question: "2. Tại sao tôi không thể đăng nhập vào tài khoản của tôi?",
        answer: "Quý khách vui lòng kiểm tra kỹ về kiểu gõ hoặc phím Caps Lock/ IN HOA trong quá trình điền thông tin đăng nhập thành viên, trường hợp không thể đăng nhập thành công quý khách vui lòng chọn nút “Quên mật khẩu” ngay dưới ô mật khẩu và nhập email đã đăng ký."
    },
    {
        question: "3. Tôi có thể sử dụng chung tài khoản với người khác được không?",
    ...
    {
        question: "5. Dola có chương trình ưu đãi nào hấp dẫn dành cho khách hàng thân thiết?",
        answer: "Khi tổng giá trị đơn hàng của quý khách tích lũy đạt đủ điều kiện của từng mức hạng thành viên, quý khách sẽ nhận được ưu đãi giảm giá cho mọi đơn hàng tương, voucher sinh nhật tương ứng của hạng mức thành viên."
    }
];

export const vedathang = [
    {
        question: "1. Tôi có thể đặt hàng bằng những hình thức nào?",
        answer: `Quý khách có thể mua hàng tại Dola bằng những hình thức sau:
    ...
    {
        question: "3. Dola có giới hạn về số lượng sản phẩm khi đặt hàng không?",
    ...
    {
        question: "4. Tôi muốn xem lại lịch sử đơn hàng đã mua?",
    ...
    {
        question: "5. Tôi cần làm gì để thay đổi hoặc huỷ bỏ đơn hàng đã đặt?",
        answer: `Quý khách vui lòng liên hệ tư vấn viên của Dola Hotline 1900 6750 để được hủy hoặc thay đổi sản phẩm trong đơn hàng.
                 Lưu ý: Đơn hàng chỉ được hủy khi đơn hàng của quý khách chưa chuyển trạng thái cho đơn vị vận chuyển.`
    },
    {
        question: "6. Tôi muốn khiếu nại/ đổi trả hàng, quy trình thực hiện như thế nào?",
...
export const vegiaohang = [ 
    {
        question: "1. Tôi không ở Hồ Chí Minh, Dola có hỗ trợ giao hàng không?",
        answer: "Dola áp dụng giao hàng trên toàn quốc cho tất cả giá trị đơn hàng. Phí vận chuyển và thời gian giao hàng sẽ thay đổi tùy thuộc vào giá trị đơn hàng và từng khu vực cụ thể."
    },
    {
    ...
    {
        question: "3. Bao lâu thì tôi sẽ nhận được sản phẩm sau khi hoàn tất đặt hàng?",
