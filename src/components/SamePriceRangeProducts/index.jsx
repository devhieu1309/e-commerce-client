...
function SamePriceRangeProducts(props) {
  const { similarPriceProducts } = props;
  console.log("MINH HIEU TEST similarPriceProducts: ", similarPriceProducts);
  return (
    <>
      <div className="mb-7">
        <div className="bg-white p-2 rounded-md">
          ...
          <div className="grid grid-cols-5 gap-3">
            {similarPriceProducts && similarPriceProducts.length > 0 ? (
              similarPriceProducts.map((product) => (
              ...
              <p>Không có sản phẩm nào cùng phân khúc giá</p>
            )}
          </div>
