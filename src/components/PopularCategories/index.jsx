    ...
    return(
        <>
            <div className="container mx-auto px-32 py-8">
                <div className="bg-white p-2 rounded-md ring-1 ring-black/10 shadow-[0_0_18px_0_rgba(0,0,0,0.06)]">
                    ...
                    <div className="flex justify-between pt-8 space-x-3">
                         <div className="bg-white py-2 px-5 w-1/4 ring-1 ring-black/10 shadow-[0_0_18px_0_rgba(0,0,0,0.06)] rounded-sm">
                            ...
                            <div className="flex py-2 justify-between group/featured">
                                <div>
                                    <h3 className="text-[18px] font-bold group-hover/featured:text-amber-400">Iphone</h3>
                                    <p className="text-[16px] text-[#000F8F] font-bold">Nhìu ưu đãi cho iphone 15</p>
                                </div>
                                <button
                                className="bg-[#F8F8F8] h-[40px] w-[40px] flex items-center justify-center rounded-full
                                            transition-transform duration-300 ease-out
                                            group-hover/featured:translate-x-1"
                                >
                                    <img className="h-[20px] w-[20px] object-contain" src="/icons8-next-50.png" alt="" />
                                </button>
                            </div>
                        </div>
                        <div className="bg-white py-2 px-5 w-1/4 ring-1 ring-black/10 shadow-[0_0_18px_0_rgba(0,0,0,0.06)] rounded-sm">
                            ...
                            <div className="flex py-2 justify-between group/featured">
                                <div>
                                    <h3 className="text-[18px] font-bold group-hover/featured:text-amber-400">Ipad</h3>
                                    <p className="text-[16px] text-[#000F8F] font-bold">Giảm giá cực sốc</p>
                                </div>
                                <button
                                className="bg-[#F8F8F8] h-[40px] w-[40px] flex items-center justify-center rounded-full
                                            transition-transform duration-300 ease-out
                        ...
                        <div className="bg-white py-2 px-5 w-1/4 ring-1 ring-black/10 shadow-[0_0_18px_0_rgba(0,0,0,0.06)] rounded-sm">
                            ...
                            <div className="flex py-2 justify-between group/featured">
                                <div>
                                    <h3 className="text-[18px] font-bold group-hover/featured:text-amber-400">Mac</h3>
                                    <p className="text-[16px] text-[#000F8F] font-bold">Giá tốt mỗi ngày</p>
                                </div>
                                <button
                                className="bg-[#F8F8F8] h-[40px] w-[40px] flex items-center justify-center rounded-full
                                            transition-transform duration-300 ease-out
                        ...
                        <div className="bg-white py-2 px-5 w-1/4 ring-1 ring-black/10 shadow-[0_0_18px_0_rgba(0,0,0,0.06)] rounded-sm">
                            ...
                            <div className="flex py-2 justify-between group/featured">
                                <div>
                                    <h3 className="text-[18px] font-bold group-hover/featured:text-amber-400">Watch</h3>
                                    <p className="text-[16px] text-[#000F8F] font-bold">Ưu đãi khủng</p>
                                </div>
                                <button
                                className="bg-[#F8F8F8] h-[40px] w-[40px] flex items-center justify-center rounded-full
                                            transition-transform duration-300 ease-out
