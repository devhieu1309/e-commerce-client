        ...
        <div>
            <div className=" container mx-auto flex justify-center items-center w-[80%] gap-5 my-10 h-[700px]">
                <div className="bg-white px-5 w-1/2 h-full ring-1 ring-black/10 shadow-[0_0_18px_0_rgba(0,0,0,0.06)] rounded-sm self-start">
                    <div>
                        <p className='font-bold text-[#000f8f] text-[25px] mt-3'>Cửa hàng Dola Phone</p>
                        <div className=" grid grid-cols-2 space-y-3 text-gray-700 mt-2">
                            ...
                            <p className="flex items-center gap-2">
                                ...
                                <div>
                                    <span className='font-semibold'>Thời gian làm việc</span><br />
                                    <span className=''>8h - 22h</span><br />
                    ...
                    <div className='mt-5'>
                        <p className='font-bold text-[#000f8f] text-[25px]'>Liên hệ với chúng tôi</p>
                        <p className="">Nếu bạn có thắc mắc gì, có thể gửi yêu cầu cho chúng tôi, và chúng tôi sẽ liên lạc lại với bạn sớm nhất có thể. </p>
                        <div className="my-5">
                            <form>
                                ...
                                <div class="mt-6 flex items-center justify-start gap-x-6">
                                    <button type="submit" class="rounded-md bg-[#000f8f] px-3 font-nomal text-white shadow-xs hover:bg-amber-300 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 w-full py-3">Gửi thông tin</button>
                                </div>
                            </form>
                        </div></div>
                </div>
